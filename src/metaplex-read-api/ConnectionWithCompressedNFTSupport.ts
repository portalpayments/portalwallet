// From https://github.com/solana-developers/compressed-nfts
// See also https://www.youtube.com/watch?v=LxhTxS9DexU
 ...
 */
// Formerly WrapperConnection
export class ConnectionWithCompressedNFTSupport extends Connection {
  constructor(
    endpoint: string,
